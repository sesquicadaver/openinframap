...
export default function friendlyNames(): { [key: string]: string } {
  return {
    power_substation_transformer: t('names.power.transformer', 'Transformer'),
    power_tower_pylon: t('names.power.tower', 'Power tower'),
    power_tower_pole: t('names.power.pole', 'Power pole'),
    power_plant_generator: t('names.power.generator', 'Generator'),
    power_plant_generator_solar: t('names.power.generator-solar', 'Solar generator'),
    power_plant_wind_turbine: t('names.power.wind-turbine', 'Wind turbine'),
    power_substation: t('names.power.substation', 'Substation'),
    power_substation_switch: t('names.power.switch', 'Switch'),
    power_substation_compensator: t('names.power.compensator', 'Compensator'),
    power_plant_converter: t('names.power.converter', 'DC converter'),
    ...
    power_plant_solar_panel: t('names.power.solar-panel', 'Solar panel'),
